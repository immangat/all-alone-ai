...
PLAYER_TEXT_SIZE_X = 100
PlAYER_TEXT_SIZE_Y = 20
...
player_one_ui_panel = pygame_gui.elements.UIPanel(relative_rect=pygame.Rect((0, 0), (500,500)), manager=manager)
button_layout_rect = pygame.Rect(-50, 0, -1, -1)
...
UILabel(relative_rect=pygame.Rect(0, 0, 180, 50),
        text='Player 1',
        manager=manager,
        container=player_one_ui_panel,
