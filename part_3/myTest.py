...
if __name__ == '__main__':
    ...
    player = "w"
    move = agent.get_best_move(board, player, 4)
    print(f"b:{move[0]}")
    print(time.process_time() - start)
    start = time.process_time()
    player = next_player(player)
    move = agent2.get_best_move(move[1], player, 4)
    print(f"w:{move[0]}")
    print(time.process_time() - start)
    start = time.process_time()
    player = next_player(player)
    move = agent.get_best_move(move[1], player, 4)
    print(f"b:{move[0]}")
    print(time.process_time() - start)
    start = time.process_time()
    player = next_player(player)
    ...
    print(f"w:{move[0]}")
    print(time.process_time() - start)
    # move = agent.get_best_move(move[1], "b", 3)
    # print(f"b:{move[0]}")
